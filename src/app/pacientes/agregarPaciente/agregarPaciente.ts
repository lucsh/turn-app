...
export class AgregarPacienteComponent implements OnInit, OnChanges {
    ...
    */
    if (this.obrasCompartidasService.obras$) {
      this.obrasSubscription = this.obrasCompartidasService.obras$.subscribe((obras) => {
        ...
        // Le agrego particular que resulta ser sin obra, para no enviar nada al server
        // de esta forma va a crear el paciente con Particular solamente
        const particular = {
          _id: 'Particular',
          nombre: 'Sin Obra',
          iniciales: 'Sin Obra'
  ...
  */
  public agregarPaciente(nombrePaciente, apellidoPaciente, dniPaciente,
    ...
    // Si es Particular lo pongo en null
    // Para que el server sepa y le agregue solamente particular
